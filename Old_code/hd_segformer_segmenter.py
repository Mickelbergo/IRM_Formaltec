...
def create_decoder2(decoder_cfg):
    decoder_cfg = decoder_cfg.copy()
    name = decoder_cfg.pop("name")
    decoder_cfg["d_encoder"] = encoder2.d_model
    decoder_cfg["patch_size"] = encoder2.patch_size

    if name == "mask_transformer":
        dim = encoder2.d_model
        n_heads = dim // 64
...
class Segmenter(nn.Module):
    def __init__(
        ...
        super().__init__()
        self.n_cls = n_cls
        self.patch_size = encoder2.patch_size
...
decoder2 = create_decoder2(decoder_cfg)
hd_vit_model = Segmenter(md_model, encoder2, decoder2, n_cls=model_cfg["n_cls"])
